...
(defun create-yxl-theme (variant theme-name)
  (dyn-let ((class '((class color) (min-colors 89))) ;;              ~~ Dark ~~                              ~~ Light ~~
        ...
        (act1          (if (eq variant 'dark) (if (true-color-p) "#132126" "#121212") (if (true-color-p) "#e9e2cb" "#d7dfff")))
        ;; mode line active color 2
        (act2          (if (eq variant 'dark) (if (true-color-p) "#073642" "#444444") (if (true-color-p) "#fcf4dc" "#afafd7")))
...
;;;;; org
     ...
     ;; `(org-level-1 ((,class (:weight bold :height 1.75))))
     ;; `(org-level-2 ((,class (:height 1.5))))
     ;; `(org-level-3 ((,class (:inherit org-level-2 :height 1.2))))
     ;; `(org-level-4 ((,class (:inherit org-level-8 :height 1.2))))
     `(org-level-1 ((,class (:inherit org-level-8 :foreground ,func))))
     `(org-level-2 ((,class (:inherit org-level-8 :foreground ,type))))
