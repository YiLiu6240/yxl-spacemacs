(setq yxl-pdf-tools-packages '(pdf-tools
                               tablist))

;; TODO: try a way to not install pdf-tools automatically on windows
;; TODO: incorporate old pdf tools config
(defun yxl-pdf-tools/init-pdf-tools ()
  (use-package pdf-tools
    :defer t
    :mode (("\\.pdf\\'" . pdf-view-mode))
    :config
    (progn
      ;; (pdf-tools-install) ;; dont auto load this
...
(defun yxl-pdf-tools/init-tablist ()
  (use-package tablist
    :defer t))
